...
<template>
  <div class="min-h-screen grid place-content-center font-inter absolute overflow-hidden z-10 w-full">
    ...
    <!-- detail -->
    <div class="md:flex md:justify-between md:space-x-4 md:items-center">
    ...
    <div class="flex space-x-4 text-center justify-center mt-4">
      <nuxt-link to="/chart"
                 class="px-6 py-2 bg-white rounded-xl text-pink-600 border-b-4 border-pink-300 hover:bg-primary hover:text-white
                        dark:bg-zinc-800 dark:hover:bg-zinc-800 dark:border-transparent dark:hover:border-b-pink-400 dark:text-white transition-all duration-100">
