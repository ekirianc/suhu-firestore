...
<template>
  <div class="relative inline-flex pt-2">
    <div @click="toggleDropdown" class="w-full bg-white border border-gray-300 px-4 py-2 pr-8 rounded leading-tight cursor-pointer hover:border-gray-400">
      <span v-if ="!chartLoaded">loading...</span>
      {{ selectedTimeRangeLabel }}
      <div class="pointer-events-none absolute -translate-y-[1.1rem] right-0 flex items-center px-2 text-gray-700">
        <Icon name="iconamoon:arrow-down-2" />
      </div>
    </div>
    <div v-show="isDropdownOpen" class="absolute top-full w-full bg-white border border-gray-300 mt-1 rounded shadow-md z-10 ">
