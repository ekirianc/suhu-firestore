...
dataStore.overall_datasets.forEach((data)=> {
  const correlation = data.accumulated_hourly_temp_diff_sum
...
<template>
  <chart-wrapper chart-name="Temp Diff Accumulated" @show-all-clicked="showAllButton" :default-collapse="!isSmallScreen"
